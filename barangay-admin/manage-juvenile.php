...
<li class="breadcrumb-item active"><span>Barangay <?php echo ucwords(strtolower($admin_location)) ?> Juvenile List</span></li>
</ol>
</nav>
</div>
</header>
...
<div class="card border-0 mb-4 shadow-sm remove_rounded">
  ...
  <div class="card-body border-0 shadow-sm remove_rounded"  id="wrapper" >
    ...
    <div class="col-lg-6 mt-1 mt-lg-1 mt-md-1 mt-sm-1 col-md-12 col-sm-12 col-12 text-sm-start hide_first_load ">
      <a id="toggle_chart1" >
      <span style="color: #294168bf;" class=" fa-solid align-content-center me-md-2"></span> Barangay <?php echo ucwords(strtolower($admin_location)) ?> Juvenile List
      </a>
    </div>
