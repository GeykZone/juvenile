...
<li class="breadcrumb-item active"><span>Manage Offenses</span></li>
</ol>
</nav>
</div>
</header>
...
<div class="card border-0 mb-4 shadow-sm remove_rounded">
  ...
  <div class=" container-fluid">
    ...
    <a id="toggle_chart1" >
      <span style="color: #294168bf;" class=" fa-solid align-content-center me-md-2"></span> juvenile Delinquent Offenses
      </a>
    </div>
    ...
    <a class="btn mb-3 border-0 shadow-sm btn-dark pt-1 pb-1 px-3 fw-bolder" data-coreui-toggle="modal" href="#add-offense" id="add_new_offense" role="button">NEW <span class="fa-solid fa-circle-plus"></span></a>
      </div>
      ...
      <table class="table table-striped table-borderless table-condensed  mb-0 w-100" id="offense_table"> 
        <thead class="fw-semibold border-0 shadow-sm" style="background-color:#202020; color: #F5F5F5;">
          <tr class="align-middle">
          <th class="w-100" >Offense Name</th>
          <th  class="w-100 text-end" style="padding-right: 25px;">Settings</th>
          </tr>
        </thead>
      ...
      <div class="table-responsive container-fluid mt-2" >
        <div class="dataTables_wrapper dt-bootstrap5 row" id="table_page">
            <div id="myProgress" class="rounded-4 border-1 d-none shadow-sm">
...
<!--scripts-->
<script src="effects/manage-offenses.js"></script>
<!--scripts end-->
