<div class="modal fade" id="filter_offense" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" >
    ...
    <div  class="modal-header shadow-sm border-0"  style="background-color:	#F0F0F0;">
      ...
      <form action="" id="offense_statistic_form" name="offense_statistic_form" method="post">
      ...
      <div class="mb-3">
        ...
        <div class="mb-3">
          <label for="offense_location_select" class="form-label">Select Offense Location:</label>
          <select id="offense_location_select"  name="offense_location_select" class="form-control gender barangay-form shadow-sm select_list">
      ...
      <button id="submit_filter_offense" class="addbtn add-brgy btn btn-dark border-0 shadow-sm">Filter</button>
      </div>
    </div>
  </div>
</div>