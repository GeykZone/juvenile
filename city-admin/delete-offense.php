...
<div id="delete_offense" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog  modal-md modal-dialog-centered modal-confirm modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-center">
				...
				<button class=" border-0 shadow-sm btn btn-danger fw-bolder" id="delete-offense" data-coreui-dismiss="modal" aria-label="Close">Delete</button>
			</div>
		</div>
	</div>
</div> 
